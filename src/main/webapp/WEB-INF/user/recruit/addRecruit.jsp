        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> 简历中心<span class="fa arrow"></span></a>
                        <!-- /.nav-second-level -->
                    </li>
                    <li>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-md-offset-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control"  id="industry" name="industry" type="text" >
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control"  id="companySize" name="companySize" type="text" >
                                    </div>
                                    <div class="form-group">
                                        <label for="companyProfile">公司简介</label>
                                        <input class="form-control"  id="companyProfile" name="companyProfile" type="text" >
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control"  id="recruitmentTelephone" name="recruitmentTelephone" type="text" >
                                    </div>
                                    <div class="form-group">
                                        <label for="companyAddress">公司地址</label>
                                        <input class="form-control"  id="companyAddress" name="companyAddress" type="text" >
                                    </div>
                                    <div class="hidden">
