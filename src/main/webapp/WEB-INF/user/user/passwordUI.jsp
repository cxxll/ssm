    ...
    <script>
       function validate() {
            ...
            if(newPassword == newPassword1) {
                document.getElementById("tishi").innerHTML="<font color='green'>两次密码相同";
                document.getElementById("submit").disabled = false;
            }
            else {
                document.getElementById("tishi").innerHTML="<font color='green'>两次密码不相同";
                            ...
                            <div class="row">
                                <div class="col-md-6 col-md-offset-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="newPassword1" name="newPassword1" type="password" onkeyup="validate()"/><span id="tishi"></span>
                                    </div>
