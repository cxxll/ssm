...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/admin/themes"><i class="fa fa-file"></i> 个人页面</a></li>
    ...
    <form action="${pageContext.request.contextPath}/admin/updateEditor?id=${loginAdmin.id}"  method="post">
        <div  style="text-align:center">
            <h1> 公告名: <input name="title" id="title" type="text"></h1>
        </div>

        <textarea id="textarea" name="textarea">公告内容</textarea>
        <input type="submit" value="保存" id="submit" onclick="submit()" />
    </form>
</div><!-- /#wrapper -->
