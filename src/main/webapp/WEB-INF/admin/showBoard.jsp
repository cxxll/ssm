...
<div id="wrapper">
    ...
    <c:forEach items="${pageList.recordList }" var="title">
        <h5><br/>
            <a href="${pageContext.request.contextPath}/board/showBoards?id=${title.id} ">${title.title}</a>
        </h5><br/>
        <div style="text-align:right">
            <a href="${pageContext.request.contextPath}/board/update?id=${title.id}">修改/</a>
            <a href="${pageContext.request.contextPath}/board/delete?id=${title.id}">删除</a>
        </div>
        <hr>
    </c:forEach>
