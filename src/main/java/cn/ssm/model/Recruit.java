...
public class Recruit {
    ...
    public Recruit(String id, String name, String industry, String nature, String companySize, String companyProfile, String contacts, String recruitmentTelephone, String companyAddress, String uId, User user, List<Recruitment> recruitments) {
        this.id = id;
        this.name = name;
