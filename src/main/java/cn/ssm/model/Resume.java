...
public class Resume {
    ...
    public Resume(String id, String jobCategory, String workPlace, String salaryExpectation, String name, String gender, String workingLife, String highestDegree, String phoneNumber, List<Recruit> recruits) {
        this.id = id;
